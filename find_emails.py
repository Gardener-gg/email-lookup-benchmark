...
def find_emails(
    ...
    with open(infile, 'r') as r, open(outfile, 'w') as w:
        ...
        w_fieldnames = ['domain', 'first_name', 'last_name', 'gardener_result', 'hunter_result', 'snov_result', 'anymail_result']
...
if __name__ == "__main__":
    ...
    find_emails(gardener_token, hunter_token, snov_token, anymail_token, infile, outfile)
